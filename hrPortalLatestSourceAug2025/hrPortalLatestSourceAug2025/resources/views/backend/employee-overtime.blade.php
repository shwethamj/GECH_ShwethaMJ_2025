                    ...
                    <tr>
                        ...
                        <td>
                            <h2 class="table-avatar">
                                ...
                                <a style="color:#33333" href="javascript:void(0)">{{ !empty($overtime->employee) ? $overtime->employee->firstname.' '.$overtime->employee->lastname: ' '}}</a>
                            </h2>
                        </td>
                ...
                <form action="{{route('overtime')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="select2" name="employee">
                            ...
                            @foreach (\App\Models\User::get() as $employee)
