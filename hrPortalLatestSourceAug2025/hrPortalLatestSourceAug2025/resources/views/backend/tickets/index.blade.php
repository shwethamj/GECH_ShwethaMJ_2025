        ...
        <div class="table-responsive">
            <table class="table table-striped custom-table mb-0" id="datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$count}}</td>
                        <td><a href="{{route('ticket-view',$ticket->subject)}}">{{$ticket->uuid}}</a></td>
                        <td>{{$ticket->subject}}</td>
                        <td>
                            <h2 class="table-avatar">
                                <a class="avatar avatar-xs" href="#">
                                {{-- <a class="" href="#"> --}}
                                    {{-- <img alt="avatar"  src="{{ !empty($ticket->employeeDetail->avatar) ? asset('storage/employee_details/'.$ticket->employeeDetail->avatar): asset('assets/img/user.jpg')}}"></a> --}}
                                  <img src="{{ !empty($ticket->employee->avatar) ? asset('storage/employee_details/'.$ticket->employee->avatar): asset('assets/img/user.jpg')}}">
                            ...
                            <div class="dropdown dropdown-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item editbtn" href="javascript:void(0)" data-id="{{$ticket->id}}" data-subject="{{$ticket->subject}}" data-employee="{{$ticket->employee_id}}" data-client="{{$ticket->client_id}}"
                                         data-priority="{{$ticket->priority}}" data-status="{{$ticket->status}}" data-uuid="{{$ticket->uuid}}" 
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="select2" multiple name="followers[]">
                                    <option value="follower" disabled selected>Select Follower</option>
                        			@foreach (\App\Models\EmployeeDetail::get() as $employee)
                        			  <option value="{{ $employee->id }}"> {{ $employee->firstname . ' ' . $employee->lastname }} </option>
                        			@endforeach
                                </select>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="select" name="status">
                                    ...
                                    <option value="ReadyForDev">Ready for Development</option>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="select" id="edit_followers" multiple name="followers[]">
                                   <option value="null" disabled selected>Select Followers</option>
