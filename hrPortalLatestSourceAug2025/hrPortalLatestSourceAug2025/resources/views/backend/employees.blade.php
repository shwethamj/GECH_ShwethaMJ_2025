...
{{-- <div class="row staff-grid-row">
	@if (!empty($employeeDetail->count()))
		@foreach ($employeeDetail as $employee)
			<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
				<a href="{{route('employee-infoProfileHR')}}">
					<div class="profile-widget">
						<div class="profile-img">
							<a href="javascript:void(0)" class="avatar"><img alt="avatar" height="80px" src="@if(!empty($employee->avatar)) {{asset('storage/employee_details/'.$employee->avatar)}} @else assets/img/profiles/default.jpg @endif"></a>
						</div>
	...
	@if (!empty($employeeDetail->count()))
		@foreach ($employeeDetail as $employee)
			<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
				<div class="profile-widget">
					<div class="profile-img">
						<a href="{{route('employee-infoProfileHR', ['user_id' => $employee->id])}}" class="avatar"><img alt="avatar" height="80px" src="@if(!empty($employee->avatar)) {{asset('storage/employee_details/'.$employee->avatar)}} @else assets/img/profiles/default.jpg @endif"></a>
					</div>
					<h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{route('employee-infoProfileHR', ['user_id' => $employee->id])}}">{{$employee->firstname}} {{$employee->lastname}}</a></h4>
					<h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="javascript:void(0)">{{$employee->designation->name}}</a></h5>
				</div>
			</div>
		@endforeach
