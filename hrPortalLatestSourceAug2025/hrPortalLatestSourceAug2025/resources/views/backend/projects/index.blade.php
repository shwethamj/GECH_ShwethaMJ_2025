                ...
                <div class="dropdown dropdown-action profile-action">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item editbtn" href="javascript:void(0)" data-id="{{$project->id}}" data-name="{{$project->name}}" 
                            ...
                            data-rate="{{$project->rate}}" data-rate_type="{{$project->rate_type}}" data-priority="{{$project->priority}}" 
                    ...
                    <ul class="team-members">
                        <li style="display:inline-flex">
                            <a href="#" data-bs-toggle="tooltip" title="{{$leader->firstname.' '.$leader->lastname}}">
                                <img alt="avatar"  src="{{ !empty($leader->avatar) ? asset('storage/employee_details/'.$leader->avatar): asset('assets/img/user.jpg')}}">
                            </a>
                            <span style="padding-top:5px"> {{$leader->firstname.' '.$leader->lastname}} </span>
                            <!--<a href="#" data-bs-toggle="tooltip" title="Leader Name: {{$leader->firstname.' '.$leader->lastname}}">-->
                            <!--  <img alt="avatar" src="{{ !empty($leader->avatar) ? asset('storage/employee_details/'.$leader->avatar): asset('assets/img/user.jpg')}}">-->
                            <!--  <div class="name"> {{$leader->firstname.' '.$leader->lastname}} </div>-->
                            <!--</a>-->
                        </li>
                    </ul>
                </div>
