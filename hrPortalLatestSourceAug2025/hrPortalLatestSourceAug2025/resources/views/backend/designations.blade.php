                        ...
                        <tr>
                            ...
                            <div class="dropdown dropdown-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a data-id="{{$designation->id}}" data-name="{{$designation->name}}" data-department="{{$designation->department->id}}" class="dropdown-item editbtn" href="javascript:void(0)" data-toggle="modal"><i class="fa fa-pencil m-r-5"></i> Edit</a>
            ...
            <div class="modal-body">
                <form action="{{route('designations')}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select" name="department" title="Select Department" placeholder="Select department">
                             <option value="Employee" disabled selected>Select Department</option>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{route('designations')}}">
                    ...
                    <div class="form-group">
                        <label>Department <span class="text-danger">*</span></label>
                        <select class="form-control select" id="department_select" name="department" selected="selected">
                             <option value="Employee" disabled selected>Select Department</option>
...
<script>
    $(document).ready(function(){
        $('.table').on('click','.editbtn',function(){
            ...
            $('#department_select').val(department).change();
        })
    });
</script>
<script>
