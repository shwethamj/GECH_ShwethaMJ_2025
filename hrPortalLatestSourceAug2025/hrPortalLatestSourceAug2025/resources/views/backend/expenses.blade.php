                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="select" name="user">
                                      <option value="null" disabled selected>Select Purchased By</option>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input placeholder="" name="amount" class="form-control" type="text">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="select" name="payment_method">
                                     <option value="null" disabled selected>Select Paid By</option>
                                    <option>Cash</option>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <!--<button type="button" class="close editbtn" data-bs-dismiss="modal" aria-label="Close">-->
                <!--    <span aria-hidden="true">&times;</span>-->
                <!--</button>-->
