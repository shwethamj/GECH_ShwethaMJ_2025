			...
			<div class="modal-body">
				<form method="post" action="{{route('assets')}}">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input class="form-control datetimepicker" name="purchase_date" type="date">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label>Warranty (In Months)  <span class="text-danger">*</span></label>
								<input class="form-control" name="warranty" type="text" placeholder="">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input name="value" placeholder="" class="form-control" type="text">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label>Status  <span class="text-danger">*</span></label>
								<select name="status" class="text form-control">
				...
				<form method="post" action="{{route('assets')}}">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label>Warranty (In Months)  <span class="text-danger">*</span></label>
								<input class="form-control edit_warranty" name="warranty" type="text" placeholder="">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label>Value  <span class="text-danger">*</span></label>
								<input name="value" placeholder="" class="form-control edit_value" type="text">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label>Status  <span class="text-danger">*</span></label>
								<select name="status" class="select form-control" id="status_select" selected="selected">
								      <option value="null" disabled selected>Select Status</option>
									<option>Pending</option>
									<option>Approved</option>
									<option>Returned</option>
