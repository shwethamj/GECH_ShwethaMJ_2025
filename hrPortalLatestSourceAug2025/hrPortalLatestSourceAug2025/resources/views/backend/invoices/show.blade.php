								...
								<div class="table-responsive no-border">
									<table class="table mb-0">
										<tbody>
											<tr>
												<th>Subtotal:</th>
												<td class="text-right">{{app(App\Settings\ThemeSettings::class)->currency_symbol.' '.$invoice->total}}</td>
											</tr>
											<tr>
											...
											<tr>
												<th>Total:</th>
												<td class="text-right text-primary"><h5>{{app(App\Settings\ThemeSettings::class)->currency_symbol.' '. (int)(($invoice->total)+(int)(($invoice->tax->percentage/100)*$invoice->total))}}</h5></td>
											</tr>
										</tbody>
									</table>
								</div>
