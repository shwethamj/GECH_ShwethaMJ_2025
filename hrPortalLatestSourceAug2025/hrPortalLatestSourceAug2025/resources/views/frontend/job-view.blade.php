...
<div class="col-md-8">
    <div class="job-info job-widget">
        ...
        <ul class="job-post-det">
            <li><i class="fa fa-calendar"></i> Start Date: <span class="text-blue">{{date_format(date_create($job->start_date),"d M,Y")}}</span></li>
            <li><i class="fa fa-calendar"></i> Last Date: <span class="text-blue">{{date_format(date_create($job->expire_date),"d M,Y")}}</span></li>
