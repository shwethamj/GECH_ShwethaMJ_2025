...
class ExpenseController extends Controller
{
    ...
    public function index()
    {
        ...
        $expenses = Expense::get();
             $expenses =Expense::whereNull('deleted_at')->orderBy('updated_at','asc')->get();
    ...
    public function store(Request $request)
    {
        ...
        [
            ...
            'user.required' => 'Purchased By cannot be empty',
            'seller.required' => 'Purchase From cannot be empty',
            'payment_method.required' => 'Paid By cannot be empty',
             'amount.required' => 'Amont cannot be empty',
            'status.unique' => 'status Cannot be empty',
